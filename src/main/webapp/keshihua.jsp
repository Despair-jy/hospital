...
<div class="main">
    ...
    <%--        年龄段--%>
    <div class="quarter-div yellow" id="main4"></div>
</div>
<script type="text/javascript">
    ...
    $.ajax({
        ...
        success : function(result) {
            ...
            if (result) {
                for (var i = 0; i < result.length; i++) {
                    names2.push(result[i].eag_layer); //挨个取出类别并填入类别数组
                }
                for (var i = 0; i < result.length; i++) {
                    nums2.push(result[i].emps); //挨个取出销量并填入销量数组
                }
