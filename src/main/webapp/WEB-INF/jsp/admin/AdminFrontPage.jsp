    ...
    <div class="header">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/keshihua.jsp">后台监控</a></li>
                <li><a href="http://182.92.184.177/myapp/xy/">大数据后台可视化</a></li>
                <li><a href="${pageContext.request.contextPath}/pu.jsp">用户访问量监控</a></li>
            </ul>
        </div>
    </div>
