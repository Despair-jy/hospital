...
public interface PatientMapper {
    ...
    @Results(value = {@Result(property = "doctor", column = "doctor_id", one = @One(select = "com.clh.mapper" +
            ".DoctorMapper.selectDoctor")), @Result(property = "bed", column = "bed_id", one = @One(select = "com.clh" +
    ...
    @Results(value = {@Result(property = "bed", column = "bed_id", one = @One(select = "com.clh" +
            ".mapper.BedMapper.selectBed"))})
